...
//
//	go build -ldflags "-X github.com/Lightning-Forge-Games/protobuf-go/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/Lightning-Forge-Games/protobuf-go/types/known/" + pkgName
	panic(fmt.Sprintf(""+
