...
// MessageV2 is the [github.com/Lightning-Forge-Games/protobuf-go/proto.Message] type used by the
// current [github.com/Lightning-Forge-Games/protobuf-go] module, adding support for reflection.
